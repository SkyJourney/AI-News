...
- [AInews 架构](ainews-project-architecture.md) — 已落地架构、文件分布、当前 14 源概览、脆弱点提示、演进路径
- [Obsidian vault/CLI 事实](obsidian-vault-cli-facts.md) — Obsidian 官方 CLI 能力边界（无法注册新 vault 须 GUI）+ AInews vault 标识
