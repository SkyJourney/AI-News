...
追踪 AI 相关政策动向、监管立法、政府干预行动及国际治理框架。

## 2026-06-28

- **Statement on the US government directive to suspend access to Fable 5 and Mythos 5** ([[202606281230-fable-mythos-export-control]])
  美国政府首次通过出口管制指令暂停具名前沿 AI 模型（Fable 5 / Mythos 5）全部访问，标志 AI 监管从框架讨论进入实际执法。
  源：`anthropic-news`
